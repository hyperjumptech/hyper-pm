...
| [Getting started](/getting-started/install) | Install from source or npm, `init`, first commands   |
| [Concepts](/concepts/data-model)            | Data branch, config, entities, and the event log     |
| [CLI reference](/cli/global-options)        | Global flags and command groups                      |
| [Integrations](/integrations/web-ui)        | Web UI, GitHub sync behavior, MCP                    |
