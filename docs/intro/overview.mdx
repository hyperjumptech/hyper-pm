...
When **sync** is enabled and credentials are present, hyper-pm can **push** ticket changes to GitHub Issues and, in **full** mode, **pull** inbound edits and attach **PR timeline** signals for tickets that are in progress and linked to issues. See [GitHub sync](/integrations/github-sync) for behavior details and limits.
